          ...
          <div class="bg-gray-50 bg-opacity-80 border-none mx-auto max-w-xl text-center border rounded p-6 ">
            ...
            <form>
              <div class="btn-group" onChange={handleLeaseTerm}>
                ...
                <input type="radio" value="other" name="options" data-title="Other" class="btn" onClick={() => setIsLeaseTermOther(true)} />
              </div>
            ...
            <form>
              <div class="btn-group" onChange={handleSpecial}>
                <input type="radio" value="1" name="options" data-title="1 Month Free" class="btn text-xs" />
                <input type="radio" value="2" name="options" data-title="2 Months Free" class="btn text-xs" />
                <input type="radio" value="other" name="options" data-title="Other" class="btn" onClick={() => setIsSpecialOther(true)} />
              </div>
