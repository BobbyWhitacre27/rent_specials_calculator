          ...
          <div class="bg-gray-50 bg-opacity-80 border-none mx-auto max-w-xl text-center border rounded p-6 ">
            ...
            <form>
              <div class="btn-group w-fit" onChange={handleSpecial}>
                ...
                <input type="radio" value="2" name="options" data-title="2 Months Free" class="btn text-x w-fit" />
                <input type="radio" value="other" name="options" data-title="Other" class="btn w-fit" onClick={() => setIsSpecialOther(true)} />
              </div>
